<?php
     include("connection.php");
                ...
                $result = mysqli_query($conn, $sql);
                 ...
                 $mysql=  "SELECT design_creative.job_title,design_creative.category,job_category.jobtitle,job_category.icon,job_category.vacancies FROM design_creative LEFT JOIN job_category ON design_creative.category = job_category.Id;";
...
<head>
    ...
    <style>
        ...
        display:grid;
        grid-template-column : repeat(4,60px);
        ...
        <div class="slider-area ">
            ...
            <div class="slider-active">
                <div class="single-slider slider-height d-flex align-items-center"
                    data-background="https://images.unsplash.com/photo-1604328698692-f76ea9498e76?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-9 col-md-10">
                                <div class="hero__caption">
                                    <h1  style="color:black">Find the most exciting startup jobs</h1>
                                </div>
                            </div>
                        </div>
                        <!-- Search Box -->
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6   ">
                           <div class="single-services text-center mb-30  ">
                               ...
                               <div class="services-cap">
                                   <h5><a href="job_listing.html"><?php   echo $row['job_title'];?></a></h5>
